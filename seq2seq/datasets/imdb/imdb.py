...
# _DOWNLOAD_URL = "../../../dataset_files/aclImdb_v1.tar.gz"
_DOWNLOAD_URL = "../../../dataset_files/aclImdb_mini.tar.gz"
...
class IMDB(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            ...
            datasets.SplitGenerator(
                name=datasets.Split.VALIDATION, gen_kwargs={"files": dl_manager.iter_archive(archive), "split": "test"}
            ),
        ]
