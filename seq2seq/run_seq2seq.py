...
sys.path.append(os.path.abspath(sys.argv[0]).replace("/seq2seq/run_seq2seq.py", "")) # Add this directory to lib path.
logging.basicConfig(
...
from seq2seq.utils.imdb import IMDBTrainer
...
def main() -> None:
    ...
    if data_args.dataset in ["imdb"]:
        trainer = IMDBTrainer(**trainer_kwargs)
    else:
